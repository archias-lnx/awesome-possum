...
_G.client.connect_signal("property::class", function(c)
	if c.class == "Spotify" then
		...
		if spotify_count > 1 then
			...
			-- Move the Spotify instance to "9" tag on this screen
			local t = awful.tag.find_by_name(awful.screen.focused(), "9")
			c:move_to_tag(t)
		end
  end
end)
