...
-- Close Button
local close_color = 'red'
theme.titlebar_close_button_normal = tip .. 'black_normal.svg'
theme.titlebar_close_button_focus = tip .. close_color .. '_normal.svg'
-- Hovered Close Button
theme.titlebar_close_button_normal_hover = tip .. close_color .. '_light.svg'
theme.titlebar_close_button_focus_hover = tip .. close_color .. '_light.svg'

-- Minimize Button
local minimize_color = 'yellow'
theme.titlebar_minimize_button_normal = tip .. 'black_normal.svg'
theme.titlebar_minimize_button_focus = tip .. minimize_color .. '_normal.svg'
-- Hovered Minimize Buttin
theme.titlebar_minimize_button_normal_hover =
  tip .. minimize_color .. '_light.svg'
...
theme.titlebar_floating_button_focus_inactive = tip .. 'black_light.svg'
...
theme.titlebar_maximized_button_normal_inactive =
  tip .. 'black_normal.svg'
theme.titlebar_maximized_button_focus_inactive =
  tip .. maximized_color .. '_normal.svg'
theme.titlebar_maximized_button_normal_active = tip .. 'black_light.svg'
theme.titlebar_maximized_button_focus_active =
  tip .. maximized_color .. '_normal.svg'
-- Hovered Maximized Button
theme.titlebar_maximized_button_normal_inactive_hover = tip .. maximized_color .. '_light.svg'
theme.titlebar_maximized_button_focus_inactive_hover =
  tip .. maximized_color .. '_light.svg'
theme.titlebar_maximized_button_normal_active_hover = tip .. 'black_light.svg'
theme.titlebar_maximized_button_focus_active_hover =
  tip .. maximized_color .. '_light.svg'

-- Ontop Button
local ontop_color = 'cyan'
theme.titlebar_ontop_button_normal_inactive = tip .. 'black_normal.svg'
theme.titlebar_ontop_button_focus_inactive = tip .. 'black_light.svg'
theme.titlebar_ontop_button_normal_active = tip .. ontop_color .. '_normal.svg'
theme.titlebar_ontop_button_focus_active = tip .. ontop_color .. '_normal.svg'
-- Hovered Ontop Button
theme.titlebar_ontop_button_normal_inactive_hover = tip .. 'black_light.svg'
theme.titlebar_ontop_button_focus_inactive_hover =
  tip .. ontop_color .. '_light.svg'
theme.titlebar_ontop_button_normal_active_hover = tip .. 'black_light.svg'
theme.titlebar_ontop_button_focus_active_hover =
  tip .. ontop_color .. '_light.svg'

-- Sticky Button
local sticky_color = 'magenta'
theme.titlebar_sticky_button_normal_inactive = tip .. 'black_normal.svg'
theme.titlebar_sticky_button_focus_inactive = tip .. 'black_light.svg'
theme.titlebar_sticky_button_normal_active = tip .. sticky_color .. '_normal.svg'
theme.titlebar_sticky_button_focus_active = tip .. sticky_color .. '_normal.svg'
-- Hovered Sticky Button
theme.titlebar_sticky_button_normal_inactive_hover = tip .. 'black_light.svg'
theme.titlebar_sticky_button_focus_inactive_hover = tip .. sticky_color .. '_light.svg'
theme.titlebar_sticky_button_normal_active_hover = tip .. 'black_light.svg'
theme.titlebar_sticky_button_focus_active_hover = tip .. sticky_color .. '_light.svg'
